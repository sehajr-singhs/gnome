...
To demonstrate that GNOmE scales to production-size models, we evaluate on Qwen2.5-1.5B\cite{qwen2024}, a 1,543.7M-parameter language model with 28 transformer layers, hidden dimension 1,536, and 12 attention heads per layer. This is the first graph-based circuit extraction on a billion-parameter model.

\begin{table}[ht]
\centering
\caption{GNOmE on Qwen2.5-1.5B (1,543.7M parameters, 28 layers). First billion-parameter circuit extraction.}
\label{tab:1b}
\small
\begin{tabular}{@{}lc@{}}
\toprule
